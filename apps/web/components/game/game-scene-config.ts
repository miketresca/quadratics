...
export const PAPER_WIDTH = 2.35;
export const PAPER_HEIGHT = 3.25;
export const PAPER_X = 0.36;
export const DESK_SURFACE_Y = 1.08;
export const PAPER_Y = DESK_SURFACE_Y + 0.035;
export const DESK_MAT_X = PAPER_X;
...
export const WORKSHEET_COMPLETE_RECT = {height: 74, width: 340, x: 760, y: 1470};
...
export const LESSON_CHOICES: LessonChoice[] = [
  {
    ...
    locked: false,
    box: {x: 150, y: 360, width: 900, height: 120}
  },
  {
    ...
    locked: true,
    box: {x: 150, y: 530, width: 900, height: 120}
  },
  {
    ...
    locked: true,
    box: {x: 150, y: 700, width: 900, height: 120}
  }
];
